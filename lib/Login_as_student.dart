...
void logins(context, String postName) {
  auth
      ...
      .then((value) {
    userreqi = value.user!.uid.toString();
    print("dddddddddddddddddddddd $userreqi");
    firebasestore = FirebaseFirestore.instance
        .collection("Students")
        .where("uid", isEqualTo: userreqi)
        .snapshots();
...
class _loginstuState extends State<loginstu> {
  ...
  void initState() {
    ...
    stat = FirebaseFirestore.instance.collection("Students").snapshots();

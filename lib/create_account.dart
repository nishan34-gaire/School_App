...
class account extends StatefulWidget {
  const account({super.key, this.restorationId});
  final String? restorationId;
  @override
  State<account> createState() => _accountState();
}

class _accountState extends State<account> with RestorationMixin {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    create = FirebaseFirestore.instance.collection(position);
  }
